...
export const UI = {
  ...
  panelHeaderInteractive: "cursor-pointer hover:bg-slate-100 transition-colors duration-200 ease-out select-none",
  ...
  buttonPrimary: "bg-[#A31241] hover:bg-[#850E34] active:scale-[0.98] text-white transition-colors duration-200 ease-out outline-none focus-visible:ring-2 focus-visible:ring-[#A31241]/50",
  buttonNeutral: "bg-slate-100 hover:bg-slate-200 active:scale-[0.98] text-slate-500 transition-colors duration-200 ease-out outline-none focus-visible:ring-2 focus-visible:ring-slate-300",
  buttonDangerGhost: "text-slate-300 hover:text-red-400 active:scale-[0.98] transition-colors duration-200 ease-out outline-none focus-visible:text-red-400",
} as const;
